...
/// verification. CryptoKit on Apple platforms; the product ships nowhere
/// else, so the portable implementation below exists only so the package
/// builds in the Linux container agents use for review.
