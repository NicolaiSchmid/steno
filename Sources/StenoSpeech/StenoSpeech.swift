...
/// Linux as well.
public enum StenoSpeech {
  /// The engine chosen when `Settings.speechEngineID` is unset or unknown.
  public static let defaultEngineID = SpeechEngineID.parakeetV3
}
...
public enum SpeechEngineError: Error, Sendable, Equatable, CustomStringConvertible {
  ...
  /// The framework returned no usable result.
  ...
  public var description: String {
    ...
    case .emptyResult(let id): "speech engine \(id) returned no result"
    }
  }
}
